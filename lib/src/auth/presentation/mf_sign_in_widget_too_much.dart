 ...
 */
class MFSignInWidgetTooMuch extends StatefulWidget {
  final String title;
  ...
  @override
  State<StatefulWidget> createState() => MFSignInWidgetTooMuchState();
}

class MFSignInWidgetTooMuchState extends State<MFSignInWidgetTooMuch> {
  ...
  Future<String?>? _onConfirmSignUp(String p1, LoginData loginData) async {
    ...
    try {
      ...
      //TODO - one not two
      // extra processins, maybe too complicated and should be removed.
      if (widget.onConfirmSignupCallback != null) {
        widget.onConfirmSignupCallback!(p1, loginData);
      }
      return 'success';
    } on AuthException catch (authException) {
      print(authException.message);
